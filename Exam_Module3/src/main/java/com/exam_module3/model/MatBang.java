package com.exam_module3.model;
...
public class MatBang {
    ...
    public MatBang(String maMatBang, double dienTich, int tang, String loaiMatBang, double giaTien, Date ngayBatDau, Date ngayKetThuc) {
